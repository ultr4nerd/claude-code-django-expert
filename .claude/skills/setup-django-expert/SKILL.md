...
echo "  /django-new-app          — Scaffold a new Django app"
echo "  /django-new-model        — Create a new model with best practices"
echo "  /django-new-api          — Create a DRF API endpoint"
echo "  /django-review           — Code review"
echo "  /django-debug            — Debug an issue"
echo "  /django-migration-check  — Verify migrations before commit"
echo "  /django-security-audit   — Security audit"
echo "  /django-performance      — Performance optimization"
echo ""
